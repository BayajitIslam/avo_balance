...
class ExtraMealSelection extends StatefulWidget {
  final String initialMealType;

  const ExtraMealSelection({super.key, required this.initialMealType});

  @override
  State<ExtraMealSelection> createState() => _ExtraMealSelectionState();
}

class _ExtraMealSelectionState extends State<ExtraMealSelection> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Upload your food photo and let our AI do the rest!',
